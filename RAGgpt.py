...
class OpenAIRAG:
    ...
    def generate(self, query: str, context: str) -> str:
        """Generate answer using OpenAI API (current syntax)"""
        try:
            completion = self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system", 
                        "content": "You are a scientific assistant. Answer the user's question using ONLY the context below. "
...
df_results.to_csv("evaluation_results_gpt.csv", index=False)
